...
export function getWebviewLocalizedStrings() {
  return {
    ...
    unableToOpenDirectoryDiff: l10n.t("error.unableToOpenDirectoryDiff"),
    ...
    openDirectoryDiff: l10n.t("action.openDirectoryDiff"),
    ...
    selectInBranchesDropdown: l10n.t("action.selectInBranchesDropdown"),
    unselectInBranchesDropdown: l10n.t("action.unselectInBranchesDropdown"),
    checkoutAndPull: l10n.t("action.checkoutAndPull"),
    dialogCheckoutAndPullConfirm: l10n.t("dialog.checkoutAndPull.confirm"),
    unableToCheckoutAndPull: l10n.t("error.unableToCheckoutAndPull"),
